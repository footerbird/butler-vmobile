...
<div style="height: 100%;" class="bg-white">
    ...
    <div class="container" style="padding-top: 45px;">
        ...
        <div class="intention-page">
            ...
            <intention-marquee>适用于需要通过注册图形或独一无二的文字商标来加强品牌辨识度，从而扩大品牌
            ...
            <div class="intention-summary">
                <div class="summary-box">
                    ...
                    <p>商标设计是确定优化性商标的创造劳动。商品命名用文字、图案表示出来就是商标。商标设计
            ...
            <div class="intention-flow pt20">
                ...
                <div class="flow-step flow-step4">
                    ...
                    <div class="step-cell step-cell-2"><p>商标设计师分析<br>并评估复杂度</p></div>
                    <div class="step-cell step-cell-3"><p>外推网业务下单<br>并成功付款</p></div>
                    <div class="step-cell step-cell-4"><p>获得商标设计图样</p></div>
                </div>
            </div>
