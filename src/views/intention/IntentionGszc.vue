...
<div style="height: 100%;" class="bg-white">
    ...
    <div class="container" style="padding-top: 45px;">
        ...
        <div class="intention-page">
            ...
            <intention-marquee>我们提供免费的公司起名和公司核名服务，最快三天拿到营业执照，顾问全程指导，
            ...
            <div class="intention-summary">
                <div class="summary-box">
                    ...
                    <p>公司注册是开始创业的第一步。一般来说，公司注册的流程包括：企业核名→提交材料→领取执照→
                    刻章，就可以完成公司注册，进行开业了。但是，公司想要正式开始经营，还需要办理以下事项：银行
                    开户→税务报到→申请税控和发票→社保开户。</p>
                </div>
            </div>
            <!-- 服务流程 -->
            <div class="intention-flow pt20">
                ...
                <div class="flow-step flow-step4">
                    ...
                    <div class="step-cell step-cell-2"><p>确定公司类型<br>制定注册方案</p></div>
                    <div class="step-cell step-cell-3"><p>外推网业务下单<br>并成功付款</p></div>
                    <div class="step-cell step-cell-4"><p>获得营业执照</p></div>
                </div>
            </div>
